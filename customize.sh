# 
TARGET_FILE="$MODPATH/system/usr/keylayout/gpio-keys.kl"
if [ ! -f "$TARGET_FILE" ]; then
  ui_print "! Error: gpio-keys.kl not found after extraction!"
...
ui_print "- Configuring gpio-keys.kl..."
...
if grep -q "key 689" "$TARGET_FILE"; then
    ...
    # Fallback if your file content is different than expected
